...
step toward proving an extensible methodology of termination proofs
...
partial automation in the future, as was done with polynomial
interpretations for non-polymorphic (\LC{Cynthia: shallowly
  polymorphic?})  higher-order rewriting. \LC{Cynthia: reference}
