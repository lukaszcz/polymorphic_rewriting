...
the rule marked (*) above. Nonetheless, this is already a substatial
step toward proving termination of IPC2 and similar systems of
higher-order logic. Verifying the orientations is still tedious, but
we introduced a general method, raising hope for at least partial
