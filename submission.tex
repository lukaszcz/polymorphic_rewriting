...
\author{\L ukasz Czajka}{Faculty of Informatics, TU Dortmund, Germany \and \url{http://www.myhomepage.edu} }{lukaszcz@mimuw.edu.pl}{https://orcid.org/0000-0002-1825-0097}{(Optional) author-specific funding acknowledgements}%TODO mandatory, please use full name; only 1 author per \author macro; first two parameters are mandatory, other parameters can be empty. Please provide at least the name of the affiliation and the country. The full address is optional
...
\keywords{Lambda calculi, termination}
...
\CK{TODO: \L ukasz, please change your author affiliation as appropriate! I did not know your orcid, for instance.}
