...
\begin{abstract}
  ...
  %% LC: Yes, I do have a bit of this Slavic languages-influenced
  %% habit, where you tend to write in long and complex sentences,
  %% which nonetheless sounds good and doesn't compromise clarity,
  %% because there is a very sophisticated grammar to disambiguate
  %% things, unlike in English where precise complex grammatical
...
%% LC: Assuming you would correct me if wrong, I didn't check this
%% (or think much about it -- in hidsight it's pretty stupid to claim
%% polynomial interpretations are complete, especially that I actually
%% learned about them at some point).
