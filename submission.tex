...
\begin{defn}\label{def_preterms}
  ...
  substitution changes the type paired to variables in~$\Vars$. We
...
%CK: Let's start this on a new page. This is going to be a lot of
%paying attention how page endings work, and I don't want to block any
%future changes to Appendix A!
\newpage
