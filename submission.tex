...
\begin{remark}
Our method builds on the work of Pol and Schwichtenberg,
who used higher-order polynomial interpretations to prove
...
they did not treat disjunction, as we will do. \LCchange{More fundamentally}, their method
...
And 28 reduction rules, including the following (the full set of rules is in Appendix \ref{app_ineqs}):
\[
\begin{array}{rclrcl}
@_{\sigma,\tau}(\abs{x}{s},t) & \red & s[x:=t] &
...
by the \LCchange{safe} interpretation:
\[
\begin{array}{rclcrcl}
\Typemap(\bot) & = & \nat
& \quad &
...
As the method is not that easy to apply manually for larger
systems, a natural direction for future work is
