...
$\sigma$. \LCchange{Thus, our interpretation terms include natural
  numbers with the operations of addition and multiplication. It would
  not cause any fundamental problems to add more operations, e.g.,
...
non-terminating~\cite{Girard1971}. \LCchange{This rule breaks
  parametricity by allowing to compare two arbitrary types.} Our rules do not allow such a
