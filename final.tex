...
% LC: I don't think this has anything to do with polynomials. We can
% easily add more monotonic non-polynomial operations. This is a more
% fundamental problem with impredicative polymorphism. You cannot have
% a model of system Fomega in which A -> B is interpreted by the set
% of all functions from A to B. This is why I think it is probably
% impossible to have a "true" generalisation of v.d. Pol, in a strict
% sense. That's why I think it's better to leave the above paragraph
% out.
