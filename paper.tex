...
\LC{We \emph{do} have pairing for all practical purposes, definable in
  ...
  then we have the encodings of pairing and existential covered. In
  general, we have the encodings of all inductive data types with one
  constructor covered. But not the encodings of lists or any inductive
  data type with more than one constructor, because then the encodings
  of constructors erase all but one argument. I think we should invent
