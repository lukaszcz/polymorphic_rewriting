...
\begin{definition}
We define the relation $\normstep$ on interpretation terms of the same
type as the smallest relation for which the following properties are
satisfied:
\begin{itemize}
...
\begin{definition}\label{def_reducibility_valuation}
  ...
  \item $\val{\forall\alpha[\sigma]}{\omega,\xi}{\Gamma}$ is the set
    ...
    \xi[\subst{\alpha}{X}]}{\Gamma}$. \CK{Replaced $\tapp{t}{\alpha}$
    by $\tapp{t}{\tau}$ here (tentatively).}
  \end{itemize}
\end{definition}
