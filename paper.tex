...
\newcommand{\typeinterpret}[1]{\langle #1 \rangle}
...
All terms will be mapped to interpretation terms, the latter of which
can be compared using $\succ$ to hopefully obtain a decrease that can
be used with rule removal.
